...
public class ServiceBefore extends ApplicationObjectSupport {
    private final LingDreamConfig.Service service;

    //region 属性/构造器
    ApplicationContext applicationContext;
    public ServiceBefore(LingDreamConfig lingDreamConfig, ApplicationContext applicationContext) {
    ...
    public Object insertBefore(ProceedingJoinPoint pjp) throws Throwable {
        //开关控制
        if (service.isServiceInsertAspectOnOff()) {
            //数据准备
    ...
    public Object updateBefore(ProceedingJoinPoint pjp) throws Throwable {
        //开关控制
        if (service.isServiceUpdateAspectOnOff()) {
            Object entity = getEntity(pjp);
