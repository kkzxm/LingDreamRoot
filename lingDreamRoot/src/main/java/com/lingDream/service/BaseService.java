...
public interface BaseService<T> {
     ...
     * 分页情况
     */
    MyPage<T> selectMyPage(MyPage<T> myPage);
    ...
    default boolean removeByMap(Map<String, Object> columnMap) {
        ...
        return SqlHelper.retBool(getMapper().deleteByMap(columnMap));
    }
    ...
    default LambdaQueryChainWrapper<T> lambdaQuery() {
        return ChainWrappers.lambdaQueryChain(getMapper());
    }
    ...
    default KtQueryChainWrapper<T> ktQuery() {
        return ChainWrappers.ktQueryChain(getMapper(), getEntityClass());
    }
    ...
    default KtUpdateChainWrapper<T> ktUpdate() {
        return ChainWrappers.ktUpdateChain(getMapper(), getEntityClass());
    }
